...
public class UserResource {
	...
	public ResponseEntity<User> insert(@RequestBody User obj){
		...
		/*return ResponseEntity.ok().body(obj);*/ /*assim retorna 200 ok e obj criado*/
		/*alterando para retornar http 201, que eh padrao*/
	...
	public ResponseEntity<Void> delete(@PathVariable Long id){
		service.delete(id);
		return ResponseEntity.noContent().build(); //cod http 204
	}
